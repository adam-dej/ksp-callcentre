...
//    private CallManager mCM;
    ...
    public InCallControlState(InCallActivity inCallScreen/*, CallManager cm*/) {
...
//        mCM = cm;
    ...
    */
    ...
    /**
     * Hacked together to provide logical behaviour for InCall UI of KSP CallCentrum
     */
    public void update() {

        // This is not a conference call
        manageConferenceVisible = false;
        manageConferenceEnabled = false;

        // User cannot add call
        canAddCall = false;

        // User cannot swap nor merge calls, only one call at a time is possible
        canSwap = false;
        canMerge = false;

        // No bluetooth headset, sorry
        bluetoothEnabled = false;
        bluetoothIndicatorOn = false;
        ...
        // They will be using the dialpad
        dialpadEnabled = true;
